...
| --- | --- | --- | --- | --- |
| `@octanejs/adapter-cloudflare` | [`packages/adapter-cloudflare`](../packages/adapter-cloudflare) | deployment adapter | `0.0.8` | 1 |
| `@octanejs/adapter-vercel` | [`packages/adapter-vercel`](../packages/adapter-vercel) | deployment adapter | `0.0.15` | 1 |
| `@octanejs/apollo-client` | [`packages/apollo-client`](../packages/apollo-client) | framework binding | `0.1.13` | 6 |
...
| `@octanejs/dexie` | [`packages/dexie`](../packages/dexie) | framework binding | `0.1.11` | 1 |
| `@octanejs/dnd-kit` | [`packages/dnd-kit`](../packages/dnd-kit) | framework binding | `0.1.13` | 4 |
...
| `@octanejs/redux-toolkit` | [`packages/redux-toolkit`](../packages/redux-toolkit) | framework binding | `0.1.13` | 4 |
| `@octanejs/remix-router` | [`packages/remix-router`](../packages/remix-router) | framework binding | `0.1.14` | 2 |
| `@octanejs/rsbuild-plugin` | [`packages/rsbuild-plugin-octane`](../packages/rsbuild-plugin-octane) | metaframework | `0.1.13` | 3 |
| `@octanejs/rspack-plugin` | [`packages/rspack-plugin-octane`](../packages/rspack-plugin-octane) | compiler integration | `0.1.13` | 2 |
| `@octanejs/seo` | [`packages/seo`](../packages/seo) | document metadata | `0.0.3` | 1 |
| `@octanejs/shadcn` | [`packages/shadcn`](../packages/shadcn) | framework binding | `0.0.3` | 2 |
| `@octanejs/sonner` | [`packages/sonner`](../packages/sonner) | framework binding | `0.1.13` | 2 |
| `@octanejs/styled-components` | [`packages/styled-components`](../packages/styled-components) | framework binding | `0.1.10` | 1 |
| `@octanejs/stylex` | [`packages/stylex`](../packages/stylex) | framework binding | `0.1.17` | 2 |
| `@octanejs/tanstack-ai` | [`packages/tanstack-ai`](../packages/tanstack-ai) | framework binding | `0.0.12` | 1 |
| `@octanejs/tanstack-devtools` | [`packages/tanstack-devtools`](../packages/tanstack-devtools) | framework binding | `0.0.12` | 1 |
| `@octanejs/tanstack-form` | [`packages/tanstack-form`](../packages/tanstack-form) | framework binding | `0.0.12` | 1 |
| `@octanejs/tanstack-hotkeys` | [`packages/tanstack-hotkeys`](../packages/tanstack-hotkeys) | framework binding | `0.0.7` | 1 |
| `@octanejs/tanstack-pacer` | [`packages/tanstack-pacer`](../packages/tanstack-pacer) | framework binding | `0.0.7` | 15 |
| `@octanejs/tanstack-query` | [`packages/tanstack-query`](../packages/tanstack-query) | framework binding | `0.1.17` | 1 |
| `@octanejs/tanstack-router` | [`packages/tanstack-router`](../packages/tanstack-router) | framework binding | `0.1.17` | 6 |
| `@octanejs/tanstack-router-ssr-query` | [`packages/tanstack-router-ssr-query`](../packages/tanstack-router-ssr-query) | framework binding | `0.0.7` | 1 |
| `@octanejs/tanstack-start` | [`packages/tanstack-start`](../packages/tanstack-start) | metaframework | `0.1.7` | 12 |
| `@octanejs/tanstack-store` | [`packages/tanstack-store`](../packages/tanstack-store) | framework binding | `0.0.12` | 1 |
| `@octanejs/tanstack-table` | [`packages/tanstack-table`](../packages/tanstack-table) | framework binding | `0.1.15` | 5 |
