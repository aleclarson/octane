...
[`packages/apollo-client`](../packages/apollo-client) `0.1.12` — ports `@apollo/client@4.2.6`. Status data: [`packages/apollo-client/status.json`](../packages/apollo-client/status.json).
...
[`packages/aria`](../packages/aria) `0.0.11` — ports `react-aria@3.50.0`. Status data: [`packages/aria/status.json`](../packages/aria/status.json).
...
[`packages/base-ui`](../packages/base-ui) `0.1.15` — ports `@base-ui/react@1.6.0`. Status data: [`packages/base-ui/status.json`](../packages/base-ui/status.json).

Alpha, in progress: 28 of 43 upstream subpaths. The foundation, overlay infrastructure, hover/focus interaction layer and popup viewport have landed, along with Dialog, AlertDialog, Popover, Tooltip, PreviewCard, the full form-control set, and the standalone Button/DirectionProvider/CSPProvider/useMediaQuery utilities — ported at full fidelity and differential-verified against the real `@base-ui/react`.
...
[`packages/cmdk`](../packages/cmdk) `0.1.0` — ports `cmdk@1.1.1`. Status data: [`packages/cmdk/status.json`](../packages/cmdk/status.json).
...
[`packages/devtools`](../packages/devtools) `0.0.5` — ports `octane@workspace`. Status data: [`packages/devtools/status.json`](../packages/devtools/status.json).
...
[`packages/dexie`](../packages/dexie) `0.1.10` — ports `dexie-react-hooks@4.4.0`. Status data: [`packages/dexie/status.json`](../packages/dexie/status.json).
...
[`packages/dnd-kit`](../packages/dnd-kit) `0.1.12` — ports `@dnd-kit/react@0.5.0`. Status data: [`packages/dnd-kit/status.json`](../packages/dnd-kit/status.json).
...
[`packages/floating-ui`](../packages/floating-ui) `0.1.16` — ports `@floating-ui/react@0.27.19`. Status data: [`packages/floating-ui/status.json`](../packages/floating-ui/status.json).
...
[`packages/hook-form`](../packages/hook-form) `0.1.14` — ports `react-hook-form@7.81.0`. Status data: [`packages/hook-form/status.json`](../packages/hook-form/status.json).
...
[`packages/i18next`](../packages/i18next) `0.1.12` — ports `react-i18next@17.0.9`. Status data: [`packages/i18next/status.json`](../packages/i18next/status.json).
...
[`packages/jotai`](../packages/jotai) `0.1.14` — ports `jotai@2.20.2`. Status data: [`packages/jotai/status.json`](../packages/jotai/status.json).
...
[`packages/lexical`](../packages/lexical) `0.1.16` — ports `@lexical/react@0.46.0`. Status data: [`packages/lexical/status.json`](../packages/lexical/status.json).
...
[`packages/lucide`](../packages/lucide) `0.1.12` — ports `lucide-react@1.24.0`. Status data: [`packages/lucide/status.json`](../packages/lucide/status.json).
...
[`packages/mdx`](../packages/mdx) `0.1.14` — ports `@mdx-js/mdx@3.1.1`. Status data: [`packages/mdx/status.json`](../packages/mdx/status.json).
...
[`packages/motion`](../packages/motion) `0.1.16` — ports `motion@12.42.2`. Status data: [`packages/motion/status.json`](../packages/motion/status.json).
...
[`packages/nuqs`](../packages/nuqs) `0.1.6` — ports `nuqs@2.9.1`. Status data: [`packages/nuqs/status.json`](../packages/nuqs/status.json).
...
[`packages/radix`](../packages/radix) `0.1.16` — ports `radix-ui@1.6.4`. Status data: [`packages/radix/status.json`](../packages/radix/status.json).
...
[`packages/recharts`](../packages/recharts) `0.1.14` — ports `recharts@3.9.2`. Status data: [`packages/recharts/status.json`](../packages/recharts/status.json).
...
[`packages/redux`](../packages/redux) `0.1.14` — ports `react-redux@9.3.0`. Status data: [`packages/redux/status.json`](../packages/redux/status.json).
...
[`packages/redux-toolkit`](../packages/redux-toolkit) `0.1.12` — ports `@reduxjs/toolkit@2.12.0`. Status data: [`packages/redux-toolkit/status.json`](../packages/redux-toolkit/status.json).
...
[`packages/remix-router`](../packages/remix-router) `0.1.13` — ports `react-router@8.2.0`. Status data: [`packages/remix-router/status.json`](../packages/remix-router/status.json).
...
[`packages/shadcn`](../packages/shadcn) `0.0.2` — ports `shadcn-ui/ui (radix base)@4baadbc6517070ae8f8feb2c97037adc2b305544 + shadcn@4.14.1`. Status data: [`packages/shadcn/status.json`](../packages/shadcn/status.json).
...
[`packages/sonner`](../packages/sonner) `0.1.12` — ports `sonner@2.0.7`. Status data: [`packages/sonner/status.json`](../packages/sonner/status.json).
...
[`packages/styled-components`](../packages/styled-components) `0.1.9` — ports `styled-components@6.4.3`. Status data: [`packages/styled-components/status.json`](../packages/styled-components/status.json).
...
[`packages/stylex`](../packages/stylex) `0.1.16` — ports `@stylexjs/stylex@0.19.0`. Status data: [`packages/stylex/status.json`](../packages/stylex/status.json).
...
[`packages/tanstack-ai`](../packages/tanstack-ai) `0.0.11` — ports `@tanstack/ai-react@0.17.0`. Status data: [`packages/tanstack-ai/status.json`](../packages/tanstack-ai/status.json).
...
[`packages/tanstack-devtools`](../packages/tanstack-devtools) `0.0.11` — ports `@tanstack/react-devtools@0.10.7`. Status data: [`packages/tanstack-devtools/status.json`](../packages/tanstack-devtools/status.json).
...
[`packages/tanstack-form`](../packages/tanstack-form) `0.0.11` — ports `@tanstack/react-form@1.33.2`. Status data: [`packages/tanstack-form/status.json`](../packages/tanstack-form/status.json).
...
[`packages/tanstack-hotkeys`](../packages/tanstack-hotkeys) `0.0.6` — ports `@tanstack/react-hotkeys@0.10.0`. Status data: [`packages/tanstack-hotkeys/status.json`](../packages/tanstack-hotkeys/status.json).
...
[`packages/tanstack-pacer`](../packages/tanstack-pacer) `0.0.6` — ports `@tanstack/react-pacer@0.22.1`. Status data: [`packages/tanstack-pacer/status.json`](../packages/tanstack-pacer/status.json).
...
[`packages/tanstack-query`](../packages/tanstack-query) `0.1.16` — ports `@tanstack/react-query@5.101.3`. Status data: [`packages/tanstack-query/status.json`](../packages/tanstack-query/status.json).
...
[`packages/tanstack-router`](../packages/tanstack-router) `0.1.16` — ports `@tanstack/react-router@1.170.18`. Status data: [`packages/tanstack-router/status.json`](../packages/tanstack-router/status.json).
...
[`packages/tanstack-router-ssr-query`](../packages/tanstack-router-ssr-query) `0.0.6` — ports `@tanstack/react-router-ssr-query@1.167.1`. Status data: [`packages/tanstack-router-ssr-query/status.json`](../packages/tanstack-router-ssr-query/status.json).
...
[`packages/tanstack-store`](../packages/tanstack-store) `0.0.11` — ports `@tanstack/react-store@0.11.0`. Status data: [`packages/tanstack-store/status.json`](../packages/tanstack-store/status.json).
...
[`packages/tanstack-table`](../packages/tanstack-table) `0.1.14` — ports `@tanstack/react-table@9.0.0-beta.58`. Status data: [`packages/tanstack-table/status.json`](../packages/tanstack-table/status.json).
...
[`packages/tanstack-virtual`](../packages/tanstack-virtual) `0.1.14` — ports `@tanstack/react-virtual@3.14.5`. Status data: [`packages/tanstack-virtual/status.json`](../packages/tanstack-virtual/status.json).
...
[`packages/tauri`](../packages/tauri) `0.0.0` — ports `@tauri-apps/api@2.11.1`. Status data: [`packages/tauri/status.json`](../packages/tauri/status.json).
...
[`packages/testing-library`](../packages/testing-library) `0.1.14` — ports `@testing-library/react` (unpinned). Status data: [`packages/testing-library/status.json`](../packages/testing-library/status.json).
...
[`packages/three`](../packages/three) `0.1.10` — ports `@react-three/fiber@9.6.1 (2a528745)`. Status data: [`packages/three/status.json`](../packages/three/status.json).
...
[`packages/tiptap`](../packages/tiptap) `0.0.11` — ports `@tiptap/react@3.28.0`. Status data: [`packages/tiptap/status.json`](../packages/tiptap/status.json).
...
[`packages/valtio`](../packages/valtio) `0.1.0` — ports `valtio@2.3.2`. Status data: [`packages/valtio/status.json`](../packages/valtio/status.json).
...
[`packages/visx`](../packages/visx) `0.1.11` — ports `@visx/visx@4.0.0 + master@485c035`. Status data: [`packages/visx/status.json`](../packages/visx/status.json).
...
[`packages/zustand`](../packages/zustand) `0.1.16` — ports `zustand@5.0.14`. Status data: [`packages/zustand/status.json`](../packages/zustand/status.json).
